...
- [ ] 1.4 Windows analysis over envelope+events (vidPid+parent identity, `adapter` always present, displays[], tunneled rule, linkDown/linkUp poll-derived, trim→snapshot); conformance test
