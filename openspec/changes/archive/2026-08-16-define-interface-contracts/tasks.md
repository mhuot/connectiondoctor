# Tasks: define-interface-contracts
- [x] 1.1 `docs/architecture.md` — one binary/three doors, in-process core decision, what is shared and how, order of work
- [x] 1.2 `docs/cli.md` — conventions, verb table with per-platform status, retired verbs, text output order
