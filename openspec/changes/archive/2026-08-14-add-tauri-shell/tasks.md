...
- [x] 1.3 tauri build → macOS .app; launch and verify render — confirmed live on the M3 (Mac15,6): app rendered the full dock topology fetched from TBDoctor --serve at 127.0.0.1:8787
